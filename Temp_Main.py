...
device_folder = glob.glob(base_dir + '28*') #set the device folder [list] as folder with 28 in them
...
while True: #This loop read value from all available sensor
	...
	Temp_Write.write_temp(device_num,temp) #save temperature value to csv file
	time.sleep(600)